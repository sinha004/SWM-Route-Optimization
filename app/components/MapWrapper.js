...
const MapWrapper = ({ dustbins, onToggleStatus, onDustbinAdd, onDustbinRemove, onDustbinUpdate, route, alternativeRoute, garageLocation, disposalSite, onGarageLocationSet, onDisposalSiteSet }) => {
  return (
    <Map
      dustbins={dustbins}
      ...
      onDustbinUpdate={onDustbinUpdate}
      route={route}
